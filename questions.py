...
@app.route("/amrquiz/startquiz", methods=["GET"])
def start_quiz():
    ...
    return redirect(url_for("display_question", question_id=first_question["question_id"]))
...
@app.route("/amrquiz/question/<string:question_id>", methods=["GET"])
def display_question(question_id):
    ...
    return render_template("single_question.html", question=question, minutes=minutes, seconds=seconds)


@app.route("/amrquiz/submit-answer/<string:question_id>", methods=["POST"])
def submit_answer(question_id):
    ...
    if time_elapsed >= session['max_time']:
        ...
        return redirect(url_for("final_submission"))
    
    if next_question:
        return redirect(url_for("display_question", question_id=next_question["question_id"]))
    else:
        return redirect(url_for("final_submission"))
    


@app.route("/amrquiz/final-submission", methods=["GET"])
